...
public class BobAndSway : MonoBehaviour
{
    ...
    void BobOffset()
    {
        ...
        speedCurve += Time.deltaTime * (mover.grounded ? walkInput.magnitude * bobExaggeration : 1f) + 0.01f;
        ...
        bobPosition.x = (Mathf.Cos(speedCurve) * bobLimit.x) - (walkInput.x * travelLimit.x);
