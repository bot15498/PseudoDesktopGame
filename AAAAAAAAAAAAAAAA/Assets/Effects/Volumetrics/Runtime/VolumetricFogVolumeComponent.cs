...
public sealed class VolumetricFogVolumeComponent : VolumeComponent, IPostProcessComponent
{
	...
	public BoolParameter enableGround = new BoolParameter(false, true);
	...
	public BoolParameter enableMainLightContribution = new BoolParameter(false, true);
	...
	public BoolParameter enableAdditionalLightsContribution = new BoolParameter(false, true);
